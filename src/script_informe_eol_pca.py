...
for i in 1:10
    ...
    dif_phs = diff_trj_avg(joinpath(dir_eol_pca, string(phs[i], "ph"), string("avg_eol_", phs[i], ".pdb")),
        joinpath(dir_eol_pca, string(phs[i], "ph"), string("full_avgfit_eol_", phs[i], ".nc")),
        collect(3:115))
...
for i in 1:10
    ...
    modes_phs, evals_phs = JUMD.readPtrajModes(
        joinpath(dir_eol_pca, string(phs[i], "ph"), string("modes_eol_", phs[i])))
    ...
    sym_smooth_prj_1_eol_phs = Symbol("smooth_prj_1_", phs[i], "_phs")
    sym_smooth_prj_2_eol_phs = Symbol("smooth_prj_2_", phs[i], "_phs")
    sym_smooth_prj_3_eol_phs = Symbol("smooth_prj_3_", phs[i], "_phs")

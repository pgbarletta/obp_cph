...
for ph in range(30, 55, 5):
    ...
    celda_ph_1=(r"""viewstruc(read(joinpath(dir_ctv_clu,  string(phs[""" + str(i) + r"""], "ph"), "top_cluster_""" + str(ph) + r""".c0.pdb"), PDB))""").strip()
    celda_ph_2=(r"""viewstruc(read(joinpath(dir_ctv_clu,  string(phs[""" + str(i) + r"""], "ph"), "top_cluster_""" + str(ph) + r""".c1.pdb"), PDB))""").strip()
    celda_ph_3=(r"""viewstruc(read(joinpath(dir_ctv_clu,  string(phs[""" + str(i) + r"""], "ph"), "top_cluster_""" + str(ph) + r""".c2.pdb"), PDB))""").strip()
...
nbf.write(nb, r'/home/pbarletta/labo/20/cph_obp/src/informe_ctv_cluster_phs_30a50.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/cph_obp/src/informe_ctv_cluster_phs_30a50.ipynb successfully generated.")

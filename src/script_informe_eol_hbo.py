...
nbf.write(nb, r'/home/pbarletta/labo/20/cph_obp/src/informe_eol_hbo.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/cph_obp/src/informe_eol_hbo.ipynb successfully generated.")

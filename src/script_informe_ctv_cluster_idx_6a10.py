...
for idx in range(6, 11):
    ...
    celda_idx_1 = (r"""viewstruc(read(joinpath(dir_ctv_clu, string(idx[""" + str(idx) + r"""]), "top_cluster_""" + str(idx) + r""".c0.pdb"), PDB))""").strip()
    celda_idx_2 = (r"""viewstruc(read(joinpath(dir_ctv_clu, string(idx[""" + str(idx) + r"""]), "top_cluster_""" + str(idx) + r""".c1.pdb"), PDB))""").strip()
    celda_idx_3 = (r"""viewstruc(read(joinpath(dir_ctv_clu, string(idx[""" + str(idx) + r"""]), "top_cluster_""" + str(idx) + r""".c2.pdb"), PDB))""").strip()
    nb['cells'].append(nbf.v4.new_markdown_cell(celda_titulo))
...
nbf.write(nb, r'/home/pbarletta/labo/20/cph_obp/src/informe_ctv_cluster_idx_6a10.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/cph_obp/src/informe_ctv_cluster_idx_6a10.ipynb successfully generated.")
